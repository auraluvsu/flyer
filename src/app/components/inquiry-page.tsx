    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const templateParams = {
                ...
                service:
                    formData.service === "initial"
                        ? "Initial Website Build"
                        : formData.service === "ongoing"
            ...
            await emailjs.send("service_49mvq4q", "template_jqt9txl", templateParams);
        ...
        >
            <div className="max-w-3xl mx-auto px-6 py-16">
                ...
                <form
                    ...
                    className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 shadow-lg p-8"
                >
