            ...
            <div className="max-w-6xl mx-auto px-6 py-12">
                ...
                <div className="mb-12">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-300 mb-6">
                        An e-commerce platform for a luxury fragrance business offering premium
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-white dark:from-gray-800 dark:to-gray-800 rounded-2xl border border-emerald-200 dark:border-gray-700 p-8 mb-12">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                        Scents4Pence needed a sophisticated e-commerce solution to showcase their
                        collection of premium fragrances while maintaining their brand promise of
                        luxury at affordable prices. The challenge was to create an online shopping
                        experience that felt high-end yet accessible.
                    </p>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                        We developed a fully functional e-commerce website with product catalogs,
                        shopping cart functionality, secure checkout, and an elegant design that
                        reflects the premium nature of their products while emphasizing value and
                        accessibility.
                    </p>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Beautiful showcase of fragrance collections with detailed
                                descriptions
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Seamless cart experience with real-time updates
                            </p>
                        </div>
                        <div>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Safe and easy payment processing integration
                            </p>
                        </div>
                        <div>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Easy navigation through extensive product catalog
                            </p>
                        </div>
                        <div>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Compelling content that connects with customers
                            </p>
                        </div>
                    </div>
                </div>
