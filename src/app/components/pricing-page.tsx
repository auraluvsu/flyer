        ...
        >
            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="space-y-8 mb-16">
                        ...
                        <div className="px-8 py-8">
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900 dark:text-white mb-1">
                                            Performance & basic SEO optimisation
                                        </h3>
                                        <p className="text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 dark:text-gray-400 text-sm">
                                            We'll get you live and running smoothly
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    {/* Ongoing Development & Maintenance Card */}
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-xl transition-shadow">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 dark:text-gray-400 text-sm">
                                            Regular improvements & additions
                                        </p>
                                    </div>
                                </div>
                ...
                <div className="mb-16">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <Link to="/projects/hart" className="group">
                            <motion.div
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 mb-4">
                                        Professional website for a life coach looking to grow their
                                        client base
                                    </p>
                        ...
                        <Link to="/projects/scents4pence" className="group">
                            <motion.div
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 mb-4">
                                        E-commerce platform for premium fragrances at affordable
                                        prices
                                    </p>
                                    <div className="flex items-center gap-2 text-emerald-600 font-semibold">
                                        <span>View Project</span>
